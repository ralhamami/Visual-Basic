...
Partial Class AboutBox1
    ...
    Private Sub InitializeComponent()
        ...
        Me.LabelProductName.Text = "Job Manager"
        ...
        Me.LabelCopyright.Text = "Author: Rayan Al-Hammami"
        ...
        Me.TextBox1.Text = "Description : This program allows the user to enter jobs and estimated hours. The" & _
    " user also has the option of saving and opening files of these details for later" & _
